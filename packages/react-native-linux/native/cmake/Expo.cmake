...
if(NOT DEFINED RN_LINUX_EXPO_MODULES_CORE)
  return()
endif()

get_filename_component(EXPO_CORE_DIR "${RN_LINUX_EXPO_MODULES_CORE}" ABSOLUTE)
...
if(NOT EXISTS ${EXPO_CPP_DIR}/EventEmitter.cpp)
  message(FATAL_ERROR
          ...
          "RN_LINUX_EXPO_MODULES_CORE should name an installed "
...
add_compile_definitions(RN_LINUX_HAS_EXPO=1)
