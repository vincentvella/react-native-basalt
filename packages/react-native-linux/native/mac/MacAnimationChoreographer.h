...
// RuntimeScheduler and are marshalled by MacMountingManager. This is purely the
...
class MacAnimationChoreographer final : public facebook::react::AnimationChoreographer {
 public:
  MacAnimationChoreographer() = default;
  ~MacAnimationChoreographer() override;
